...
import { ClipboardList, HeartHandshake, MapPin, FileBarChart, Download, Users, Carrot, Leaf, Wheat, Sprout, ArrowRight } from 'lucide-react';
       ...
       <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 -mt-48 space-y-12">
          ...
          <div className="bg-white rounded-2xl shadow-lg border border-[#e2e8f0] p-8 md:p-12 flex flex-col md:flex-row items-center gap-12">
             <div className="flex-1 space-y-6">
                ...
                <p className="text-lg text-stone-600 leading-relaxed max-w-lg">
                   Visualizing the gap between <strong>Affordability</strong> and <strong>Availability</strong> of healthy food in our community.
                </p>
          ...
          <div className="grid md:grid-cols-12 gap-12 items-center py-8">
             <div className="md:col-span-7 space-y-6">
                <h2 className="text-3xl font-bold text-[#14532d]">About This Project</h2>
                <p className="text-stone-600 text-lg leading-relaxed">
                    This dashboard visualizes responses from our new "Share your food needs" survey. By collecting data directly from residents in Santa Clara County, we aim to pinpoint the specific nature of food insecurity.
                </p>
                <div className="flex gap-4 border-l-4 border-[#84cc16] pl-6 py-1">
                   <p className="text-stone-700 font-medium leading-relaxed">
                      We specifically track whether barriers are due to <span className="text-red-500 font-bold">Cost</span> (Affordability) or <span className="text-sky-600 font-bold">Physical Availability</span> at local stores. We also gather input on <span className="text-[#4d7c0f] font-bold">Educational Interests</span> like growing food or preparing healthy meals.
                   </p>
                </div>
             </div>
             ...
             <div className="md:col-span-5">
                <div className="w-full aspect-video bg-[#f1f5f9] rounded-xl border-2 border-dashed border-[#94a3b8] flex flex-col items-center justify-center text-stone-400">
                   <FileBarChart size={64} strokeWidth={1} className="mb-4 text-stone-300" />
                </div>
             </div>
          </div>
          ...
          <div className="space-y-8">
             <h2 className="text-3xl font-bold text-[#1b4332] text-center">How to Use This Dashboard</h2>
             <div className="grid md:grid-cols-3 gap-8">
                ...
                >
                   ...
                   <h3 className="text-xl font-bold text-[#1b4332] mb-3 group-hover:text-[#ea580c] transition-colors">Gap Analysis</h3>
                   <p className="text-stone-500 mb-8 flex-1 leading-relaxed">
                      See the difference between what people can't afford vs. what they can't find.
                   </p>
                ...
                >
                   ...
                   <h3 className="text-xl font-bold text-[#1b4332] mb-3 group-hover:text-[#475569] transition-colors">Demographics & Geo</h3>
                   <p className="text-stone-500 mb-8 flex-1 leading-relaxed">
                      View data by Zip Code, income, and household size to understand who we are serving.
                   </p>
                   <div className="flex items-center text-[#1b4332] font-bold text-sm group-hover:translate-x-1 transition-transform">
                ...
                <div className="bg-white p-8 rounded-xl border border-[#e2e8f0] shadow-sm hover:shadow-xl hover:-translate-y-1 transition-all duration-300 flex flex-col h-full text-left group">
                   ...
                   <h3 className="text-xl font-bold text-[#1b4332] mb-3 group-hover:text-[#15803d] transition-colors">Impact Reports</h3>
                   <p className="text-stone-500 mb-8 flex-1 leading-relaxed">
                      Download anonymized data or generate weekly reports for stakeholders and grant reporting.
                   </p>
          ...
          <div className="text-center pt-12 pb-4">
             <p className="text-stone-400 text-sm flex items-center justify-center gap-2">
                <Users size={16} />
                All public data presented here is <strong>anonymized</strong> to protect respondent privacy.
             </p>
          </div>
